...
<script type="text/javascript">
            ...
            t.row.add( [
               '<select name="Goods" id = "Goods" class="select" onchange="change(this)">'+
                ...
                '<input type="text" onchange="tot()" class="input-text" value="1" placeholder="输入租借物品数量" id="rent_num" name="rent_num">'
                    +'</div>',
                '<div class="formControls col-xs-10 col-sm-9">'+
                '<input type="text" onchange="tot()" class="input-text"  value="${goods[0].good_value}" placeholder="租借价格" id="rent_value" name="rent_value">'+
                    '</div>',
                '<div class="formControls col-xs-8 col-sm-9">'+
    ...
    function formSubmit(){
        ...
        var list = "{ rent_id:"+$("#rent_id").val()+", user_id:"+$("#Users").find("option:selected").val()
