...
<body>
<nav class="breadcrumb">入库管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="Stackin_add('添加入库','<%=basePath%>Stackin/goAdd','','800')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加入库</a></span> <span class="r">共有数据：<strong>${tot}</strong> 条</span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort dataTables-example">
            ...
            <c:forEach items="${varList}" var="var" varStatus="status">
                <tr class="text-c">
                    ...
                    <td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="Stackin_del(this,'${var.batchcode}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
...
<script>
    ...
    /*分类-添加*/
    function Stackin_add(title,url,pid,w,h){
        layer_show(title,url,w,h);
    }


    /*入库-删除*/
    function Stackin_del(obj,id){
    ...
    function deleteuser(batchcode,num){
        ...
        var url = "<%=basePath%>Stackin/deleteMuch";
