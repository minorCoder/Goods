    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="分类编号" id="pid" name="pid">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="分类名" id="Name" name="Name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="message" id = "message" cols="" rows="" class="textarea"  placeholder="分类描述" onKeyUp="$.Huitextarealength(this,100)"></textarea>
...
<script type="text/javascript">
    ...
    function formSubmit(){
        ...
        $.post("<%=basePath%>Category/add",data,function(rback){
            //alert(rback);
