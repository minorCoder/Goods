    ...
    <form action="" method="post" class="form form-horizontal" id="form-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${reservation.reservation_id}" placeholder="输入借用编码"  id="reservation_id" name="reservation_id" disabled>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>借用人：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${reservation.name}" data = "${reservation.reservation_id}" placeholder="输入借用人" id="user" name="user" disabled>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onchange="tot()" name ="Day" id = "Day" placeholder="租用天数" value="${reservation.reservation_da}" class="input-text" style="width:90%" disabled>
            </div>
        </div>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 审核通过 </button>
            </div>
        </div>
        </c:if>
        </div>
...
<script type="text/javascript">
    ...
    function formSubmit(){
        ...
        $.post("<%=basePath%>Reservation/check",data,function(rback){
            alert(rback.msg);
