    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="Storages" id = "Storages" class="select" onchange="Selchang();">
...
<script type="text/javascript">
    ...
    function Selchang(){
        var storage_id = $("#Storages").find("option:selected").val();
        //alert(storage_id);
        $.ajax({
            url:"<%=basePath%>Stackout/getGood",
            ...
            success:function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#Goods").append("<option value ="+data[0].good_code+">"+data[0].good_name+"</option>");
                }
            }
        })
    }
    ...
    function formSubmit(){
        ...
        $.post("<%=basePath%>Stackout/add",data,function(rback){
            //alert(rback);
