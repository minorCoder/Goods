...
(/** @lends <global> */function( $ ) {
	 ...
	 *    Hungarian value in the `system` object will be overwritten. Otherwise they
	 *    won't be.
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		else
		{
			...
			/* Don't require that the system must specify bRegex, bSmart or bCaseInsensitive */
	...
	function _fnBuildHead( oSettings )
	{
		...
		// row in the footer. If there is more than one row the system wants to
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		/* Loop over the system set positioning and place the elements as needed */
	...
	/**
	 * Filter the data table based on system input and draw the table
	 *  @param {object} settings dataTables settings object
	...
	/**
	 * Generate the node required for system display length changing
	 *  @param {object} settings dataTables settings object
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			// And give the system a warning that we've stopped the table getting too small
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		/* Convert any system input sizes into pixel sizes */
		...
		else
		{
			...
			// data, assign any system defined widths, then insert it into the DOM and
			...
			// the table width should be by summing the system given values, and the
			// automatic values
			if ( scrollX )
			{
				var total = 0;
	...
	/**
	 * Function to run on system sort request
	 *  @param {object} settings dataTables settings object
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		// callback used for async system interaction
	 ...
	 *  @param {object} settings dataTables settings object
	 *  @param {int} level log error messages, or display them to the system
	...
	DataTable.defaults = {
		 ...
		 * cannot be overridden by system interaction with the table. What this means
		 * is that you could have a column (visible or hidden) which the sorting
		 * will always be forced on first - any sorting after that (from the system)
		 ...
		 * that it allows the end system to input multiple words (space separated) and
		...
		/**
		 * Allows the end system to select the size of a formatted page from a select
		 ...
		 * same time (activated by shift-click by the system).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Options
		 ...
		 * display length, filtering and sorting. As such when the end system reloads
		 ...
		 * rendered as "1,000,000") to help readability for the end system. This
		 ...
		 * feature enabled (`lengthChange`) then the end system will be able to override
		...
		/**
		 * All strings that DataTables uses in the system interface that it creates
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 * button to take the system to the first page.
				 *  @type string
				 *  @default First
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use when using the 'full_numbers' type of pagination for the
				 * button to take the system to the last page.
				 *  @type string
				 *  @default Last
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use for the 'next' pagination button (to take the system to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
				...
				/**
				 * Text to use for the 'previous' pagination button (to take the system to
				 * the previous page).
				 *  @type string
				 *  @default Previous
				 *
			...
			/**
			 * This string gives information to the end system about the information
			...
			/**
			 * When a system filters the information in a table, this string is appended
			 ...
			 * indicate to the end system the the data is being loaded. Note that this
			...
			/**
			 * Text which is displayed when the table is processing a system action
			...
			/**
			 * Details the actions that will be taken when the system types into the
	...
	DataTable.defaults.column = {
		 ...
		 *    // (which has both forms) is used for filtering for if a system inputs either format, while
		 ...
		 * version) prior to ordering. This allows ordering to occur on system
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Present a system control allowing the end system to change the page size
			 ...
			 * system request - typically an Ajax request for server-side processing.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
		...
		/**
		 * List of options that can be used for the system selectable length menu.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
	...
	DataTable.ext = _ext = {
		 ...
		 *    // from the end-system, matching the data in a certain range.
	 ...
	 * the end system that there is something happening, or that something has
	 * finished.
